<?php
//admin can search by serviceid, ename, description and status from the textbox
...
?>
			...
			<input type="text" name="search" id="myInput" onkeyup="myFunction()" placeholder="Search" title="Type in a name">
...
?>
  <tr>
	...
	<td><?php echo "<form method='POST' action='UpdateEmployeeStatus.php'><input type='hidden' name='serviceID' value='".$row['serviceID']."' /><input type='hidden' name='ename' value='".$row['ename']."' />
