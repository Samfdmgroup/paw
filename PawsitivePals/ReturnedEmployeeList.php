...
<head>
<title>List All Rented Employee</title>
<meta charset="UTF-8">
...
//finding that service that the user rented 
$sql = "SELECT * FROM History WHERE rentBy='".$_SESSION['name']."'";
...
echo "<tr>
 ...
 <th style=''>Returned Date</th>
 <th style=''>Rented By</th></tr>\n";
